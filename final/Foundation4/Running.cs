class Running : Activity
{
    ...
    {
        return $"\n{GetDateTime().ToString("dd MMM yyyy")} Running ({CalculateActivityTime(GetDistance(),GetSpeed())} min)-Distance {GetDistance()}, Speed {GetSpeed()} MPH, Pace: {GetPace()} minutes per {GetUnitOfMeasurement()}\n";
    }
}